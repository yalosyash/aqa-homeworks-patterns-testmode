...
class AuthTest {
    ...
    void shouldSuccessfulLoginIfRegisteredActiveUser() {
        ...
        fillingForm(registeredUser.getLogin(), registeredUser.getPassword());
        $(privateCabinet).shouldBe(visible).shouldHave(text("Личный кабинет"));
    }
    ...
    void shouldGetErrorIfNotRegisteredUser() {
        ...
        fillingForm(notRegisteredUser.getLogin(), notRegisteredUser.getPassword());
    ...
    void shouldGetErrorIfBlockedUser() {
        ...
        fillingForm(blockedUser.getLogin(), blockedUser.getPassword());
        $(error).shouldBe(visible).shouldHave(text("Пользователь заблокирован"));
    }
    ...
    void shouldGetErrorIfWrongLogin() {
        ...
        fillingForm(wrongLogin, registeredUser.getPassword());
        $(error).shouldBe(visible).shouldHave(text("Неверно указан логин или пароль"));
    }
